...
const ENTRY_STEPS = [
  {
    ...
    text: getCopyText(
      ...
      "Просто нажмите кнопку входа. Это самый удобный и безопасный способ попасть в личный кабинет без лишней авторизации.",
    ),
  },
  {
            ...
            <div className="rounded-3xl border border-slate-200/70 bg-slate-50/80 p-5 dark:border-slate-800/70 dark:bg-slate-950/30">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-300">
                {getCopyText(
                  ...
                  "Если окно Telegram не появилось само, нажмите на кнопку подтверждения прямо тут. Это привычный и аккуратный путь войти в кабинет без лишних шагов.",
                )}
              </p>
            </div>
          </div>
