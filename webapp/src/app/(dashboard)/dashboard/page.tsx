    ...
    <main className="space-y-6">
      ...
      <section className="glass-card p-7">
        ...
        <div className="grid gap-5 lg:grid-cols-[1.4fr,0.9fr]">
          ...
          <article className="rounded-2xl border border-white/45 bg-white/65 p-4 dark:border-white/10 dark:bg-white/5">
            ...
            {qrUrl ? (
              <img src={qrUrl} alt="QR key" className="mt-3 h-[220px] w-[220px] max-w-full rounded-xl border border-white/45 bg-white p-2" />
            ) : (
      ...
      <section className="glass-card p-7">
        ...
        <p className="mt-4 text-sm text-slate-600 dark:text-slate-300">
          Почему часть медиасервисов может идти напрямую: в некоторых сценариях прямой маршрут уменьшает задержку и улучшает
          стабильность воспроизведения. VPN-канал при этом сохраняется для основного трафика по вашему тарифу.
        </p>
      </section>
    </main>
  );
