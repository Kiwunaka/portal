...
const FAQ_ENTRIES = [
  {
    ...
    answer:
      "Android: скачайте APK. Windows: скачайте EXE. Затем войдите тем же способом, что и в кабинет, и нажмите «Подключить».\n\nДля iPhone, iPad и Mac откройте «Apple: ручное подключение» в разделе подписки и добавьте личный ключ в совместимое приложение.",
  },
  {
  ...
  {
    question: "Как подключить iPhone, iPad или Mac?",
    answer:
      "Нативного приложения POKROV для Apple пока нет. Откройте раздел подписки → «Apple: ручное подключение», установите совместимое приложение и добавьте личный ключ или QR. Для Happ используйте отдельную кнопку. Не пересылайте ключ: по нему можно пользоваться вашим доступом.",
  },
];
