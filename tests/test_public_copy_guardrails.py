...
TELEGRAM_START_PROMISE = (
    "5 дней бесплатно в приложении. После первой оплаты можно получить ещё 5 дней за привязку "
    "Telegram и подтверждение подписки на канал."
)

PAID_REWARDS_MARKETING_COPY = (
    "Для активной платной подписки доступно колесо бонусов раз в 14 дней. В нём есть скидки, "
    "бонусные дни и редкий джекпот +30 дней; календарь пока отключён."
)
