...
def _workflow_contract_errors(source: str) -> list[str]:
    required = (
        ...
        "Reclaim verified historical artifact space",
        '[IO.Path]::Combine($clientRoot, "artifacts")',
        '[IO.Path]::Combine($clientRoot, ".git", "lfs", "objects")',
...
def _validate_contract_data(root: Path, contract: dict[str, Any]) -> dict[str, str]:
    ...
    require(
        control.get("target_revision") == "a25fa8a9ec5fe9e4032a65e152c9852c5c78e45b",
