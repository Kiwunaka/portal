...
TABLE_DEPENDENCIES: dict[str, set[str]] = {
    ...
    "account_entitlement_grants": {"accounts", "connection_evidence"},
...
ECONOMY_INVARIANT_RELATIONS = (
    ...
    ("account_entitlement_grants", "activation_evidence_id", "connection_evidence", "id"),
    ...
    ("referral_relationships", "friend_grant_id", "account_entitlement_grants", "id"),
    ("referral_relationships", "referrer_grant_id", "account_entitlement_grants", "id"),
...
def run_invariant_checks(connection: Connection, metadata: MetaData) -> list[dict[str, Any]]:
    ...
    relations = ECONOMY_INVARIANT_RELATIONS + (
        ...
        ("account_entitlement_grants", "account_id", "accounts", "id"),
