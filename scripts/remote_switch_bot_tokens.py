...
def main() -> int:
    ...
    ap.add_argument("--new-bot-username", default="pokrov_vpnbot")
    ap.add_argument("--migration-target-url", default="https://t.me/pokrov_vpnbot")
    ...
    ap.add_argument("--support-username", default="pokrov_supportbot")
