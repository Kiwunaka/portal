...
DEFAULT_POST_DEPLOY_PROBE = Path("docs/audit-artifacts/public-beta-post-deploy-probe-2026-05-14.json")
    ...
    *,
    ...
    return {
        ...
        "unsafe_public_claims": [
            ...
            "RU-origin доступность POKROV API, публичных хостов и нод проверена, когда внешняя проверка говорит SKIPPED_BY_OPERATOR.",
        ],
    }
