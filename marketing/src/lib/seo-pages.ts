...
export const SEO_INDEXABLE_PAGES: SeoPage[] = [
  ...
  withDefaults({
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Да, потому что страница установки ведёт к публичному POKROV Releases. Случайные архивы и зеркала лучше не использовать.",
      },
      {
    ...
    sections: [
      {
        ...
        body:
          "Проверьте, что файл скачан из публичного POKROV Releases. Если браузер просит подтвердить загрузку APK, это обычная защита Android от файлов вне магазина.",
      },
      {
  ...
  withDefaults({
    ...
    cards: [
      ...
      },
      {
        ...
        body: "Выберите срок от 99 ₽ или не продлевайте. Автосписаний нет.",
      },
    ],
    changeFrequency: "weekly",
    cluster: "trial",
  ...
  withDefaults({
    answer:
      "POKROV не списывает деньги сам: оплачиваете только выбранный срок, пользуетесь и продлеваете вручную. Сначала получите 5 дней бесплатно без карты, затем выберите 30 дней от 99 ₽ или длинный тариф со скидкой до 30%.",
    ...
    heroKicker: "0 автосписаний · от 99 ₽ · скидка до 30%",
    kind: "intent",
  ...
  withDefaults({
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Для Android страница установки ведёт прямо на актуальный APK в GitHub Releases. Windows-файл по-прежнему открывается через кабинет.",
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "Используйте кнопку на официальной странице установки: она ведёт на актуальный Android-релиз. Не берите APK из комментариев, пересланных архивов и чужих зеркал.",
      },
    ],
  ...
  withDefaults({
    ...
    cards: [
      ...
      },
      {
        ...
        body: "Вы выбираете и оплачиваете конкретный срок. Длинный тариф экономит до 30%.",
      },
    ],
    changeFrequency: "weekly",
    cluster: "compare",
  ...
  withDefaults({
    ...
    cards: [
      ...
      },
      {
        eyebrow: "Критерий",
        title: "Что бесплатно",
        body: "Нормальная страница сразу объясняет: разовый trial, его срок и цену после него. Туман тут обычно плохой знак.",
      },
      {
        eyebrow: "Критерий",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Нет. Есть один бесплатный старт на 5 дней без карты. После trial доступ останавливается, пока вы сами не выберете платный срок.",
      },
      {
  ...
  withDefaults({
    answer:
      "Откройте инструкцию для своего устройства. Если ошибка остаётся — отправьте в поддержку модель, версию системы и текст ошибки.",
    breadcrumbName: "Помощь с установкой",
    cards: [
      {
        eyebrow: "Android",
        title: "APK не ставится",
        body: "Сверьте источник и версию Android. Если ARM64 не ставится — откройте другой APK в кабинете.",
      },
      {
        eyebrow: "Windows",
        title: "SmartScreen спорит",
        body: "Для файла из кабинета: «Подробнее» → «Выполнить в любом случае».",
      },
      {
        eyebrow: "Подключение",
        title: "Кнопка не помогла",
        body: "Укажите сеть, сервис и текст ошибки — этого хватит для первого ответа.",
      },
    ],
    changeFrequency: "weekly",
    cluster: "support",
    ...
    sections: [
      {
        ...
        bullets: [
          "Android: модель телефона, версия системы и имя скачанного APK.",
  ...
  withDefaults({
    answer:
      "Скачайте POKROV для Android или Windows, установите официальный файл и нажмите «Подключить». Android APK доступен напрямую, Windows-файл — через кабинет; в приложении ждут 5 дней бесплатно без карты.",
    ...
    faq: [
      ...
      {
        question: "Откуда скачивается официальный файл?",
        answer:
          "Android APK скачивается напрямую из публичного POKROV Releases, Windows-файл открывается через кабинет. Оба пути ведут на официальные артефакты.",
      },
      {
