...
export const MARKETING_FEATURE_LIST = [
  ...
  "5 дней доступа без карты",
  "Один кабинет для доступа, устройств и продления",
  "Платные планы до 5 устройств",
...
export const MARKETING_FAQ: MarketingFaqItem[] = [
  {
    ...
    answer:
      "Скачайте приложение для Android или Windows, откройте его и активируйте 5 дней доступа без карты.",
  },
  {
    question: "Что будет после бесплатных 5 дней?",
    answer:
      "Можно выбрать платный срок в кабинете или остаться на базовом режиме. Цена, срок и лимит устройств видны до оплаты.",
  },
  {
...
export function buildOrganizationJsonLd() {
  return {
    ...
    description:
      "POKROV помогает начать через приложение, получить 5 дней доступа без карты и дальше управлять сроком, устройствами и поддержкой.",
...
export function buildSoftwareApplicationJsonLd(options?: {
  ...
  return {
    ...
    url: canonicalUrl,
    description:
      "POKROV помогает начать с приложения на Android или Windows, получить 5 дней доступа без карты и дальше управлять сроком и устройствами.",
  };
}
