...
export const MARKETING_FAQ: MarketingFaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Во время теста доступен полноценный доступ: основные локации, стабильное подключение и тот же интерфейс, который остаётся после продления.",
  },
  {
    question: "Как проходит оплата?",
    answer:
      "Публичная страница только объясняет следующий шаг. Само продление и оплату мы открываем только после входа в кабинет или продолжения из Telegram.",
  },
  {
    question: "Куда писать, если нужна помощь?",
    answer:
      "Для поддержки используйте @pokrov_supportbot или письмо на support@pokrov.space. Если нужно, мы подскажем понятный следующий шаг по оплате или подключению.",
  },
];
