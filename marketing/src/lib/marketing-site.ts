...
export const MARKETING_FAQ: MarketingFaqItem[] = [
  {
    ...
    answer:
      "Скачайте приложение для Android или Windows, откройте его и нажмите «Попробовать 5 дней». Никакой лишней переписки для старта не нужно.",
  },
  {
    question: "Что будет после бесплатных 5 дней?",
    answer:
      "Вы сможете выбрать платный срок и продолжить в том же аккаунте. Если с продлением что-то не так, кабинет и поддержка помогут разобраться.",
  },
  {
    question: "Как устроено продление?",
    answer:
      "Вы выбираете срок, покупаете ключ доступа и активируете его в приложении или кабинете. Доступ продолжится в том же аккаунте.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Сначала откройте кабинет или раздел поддержки в приложении. В бета-волне команда отвечает в формате best-effort с целевым окном до 24 часов.",
  },
];
...
export function buildOrganizationJsonLd() {
  return {
    ...
    description:
      "POKROV помогает начать через приложение, спокойно проверить подключение и дальше управлять доступом без возни.",
...
export function buildSoftwareApplicationJsonLd(options?: {
  ...
  return {
    ...
    url: canonicalUrl,
    description:
      "POKROV помогает начать с приложения на Android или Windows, получить 5 дней проверки и дальше спокойно управлять доступом и устройствами.",
  };
}
