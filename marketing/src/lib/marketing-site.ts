...
export const MARKETING_FAQ: MarketingFaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Выберите платный срок в кабинете и продолжайте в том же аккаунте. Цена и условия видны до оплаты, поддержка рядом.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Откройте кабинет или напишите в поддержку. Мы подскажем, где скачать сборку, как войти и что делать с продлением.",
  },
];
...
export function buildOrganizationJsonLd() {
  return {
    ...
    description:
      "POKROV помогает начать через приложение, получить 5 дней бесплатно и дальше управлять доступом без лишней технической путаницы.",
...
export function buildSoftwareApplicationJsonLd(options?: {
  ...
  return {
    ...
    url: canonicalUrl,
    description:
      "POKROV помогает начать с приложения на Android или Windows, получить бесплатные 5 дней и дальше управлять доступом и устройствами.",
  };
}
