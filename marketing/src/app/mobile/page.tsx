...
export const metadata = buildMarketingMetadata(
  ...
  "POKROV на Android: 5 дней доступа без карты, быстрый старт в приложении и управление в кабинете.",
  {
    ...
    <>
      ...
      <div className="lp-route-shell lp-route-shell--intent lp-route-shell--mobile">
        <MarketingLanding
          ...
          heroSubtitle="Установите приложение, активируйте бесплатный период и пользуйтесь привычными сервисами на телефоне."
          ...
          scenarioCards={[
            {
              ...
              desc: "Android-приложение быстро доводит до первого включения без прыжков по техническим ссылкам.",
            },
            {
              eyebrow: "Повседневный ритм",
              glyph: "signal",
              title: "Используйте там, где живёте каждый день",
