    ...
    <>
      ...
      <div className="lp-route-shell lp-route-shell--intent lp-route-shell--mobile">
        <MarketingLanding
          ...
          heroSubtitle="Если нужен быстрый мобильный маршрут, начните с приложения, включите тест на 5 дней и оцените связь в привычном ритме уже сегодня."
          scenarioTitle="Почему это удобно на телефоне"
          scenarioBody="В мобильном сценарии особенно важны короткий путь к действию, стабильная связь и отсутствие лишней настройки."
          scenarioCards={[
            {
            ...
            },
            {
              ...
              desc: "Открываете привычные приложения и сразу видите, насколько спокойно и стабильно всё работает.",
            },
            {
