...
const VPN_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Нет. Есть бесплатный старт на 5 дней без карты и базовый бесплатный режим после пробного периода. Для регулярного использования предусмотрены платные сроки с понятной оплатой через официальный checkout.",
  },
];
          ...
          <section className="lp-section lp-longform">
            ...
            <div className="lp-longform-grid">
              <article className="lp-longform-article">
                ...
                <p>
                  Текущая публичная бета рассчитана на Android и Windows. Для Android используется APK-бета. Для Windows
                  доступен EXE-контур, при этом система может предупреждать о неизвестном издателе, пока отдельный
                  release-gate по trusted signing не закрыт. Мы лучше скажем об этом прямо, чем спрячем важную деталь в
                  мелком шрифте.
                </p>
                ...
                <p>
                  ...
                  checkout. Telegram-бонус дает +10 дней за подписку на канал, а платные планы могут включать несколько
              ...
              <aside className="lp-longform-aside" aria-label="Короткая сводка">
                ...
                <div className="lp-info-card">
                  ...
                  <p>Откройте страницу установки и проверьте доступность сборки для аккаунта.</p>
                  <Link href={MARKETING_CANONICAL_PATHS.install} className="lp-btn lp-btn--primary">
                    Открыть установку
                  </Link>
                </div>
