...
export default function VpnTelegramBotPage() {
  return (
    <MarketingLanding
      ...
      heroSubtitle="Бот помогает продолжить сценарий, если нужен быстрый вход, персональная ссылка на оплату, служба заботы или восстановление доступа. Но основной путь релиза мы строим через приложение."
