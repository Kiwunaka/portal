const TG_FALLBACK = "https://t.me/portal_privacy_bot";
...
export default function OfferPage() {
  return (
    <main className="legal-page">
      ...
      <p>
        Настоящий документ определяет условия предоставления VPN-сервиса PORTAL. Используя сервис и оплачивая выбранный
        период доступа, пользователь подтверждает согласие с условиями оферты.
      </p>
      <ul>
        <li>VPN-сервис предоставляется в формате digital-услуги и работает по модели best-effort.</li>
