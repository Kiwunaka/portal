...
- Onboarding (external snapshot: `raw/market-wave2/2026-07-12/screenshots/app-oversecure-onboarding.png`)
- Home (external snapshot: `raw/market-wave2/2026-07-12/screenshots/app-oversecure-main.png`)
- Settings (external snapshot: `raw/market-wave2/2026-07-12/screenshots/app-oversecure-settings.png`)
- Split apps (external snapshot: `raw/market-wave2/2026-07-12/screenshots/app-oversecure-split-apps.png`)
