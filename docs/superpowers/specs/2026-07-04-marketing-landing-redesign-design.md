...
7. **Pricing** — trial card first («5 дней бесплатно — карта не нужна»), then `start_99` hero plan (99 ₽ / 30 дней, 1 устройство) and the 249/699/1199/1399/1644 ladder from `shared/tariff-catalog.ts` with honest per-month math («12 месяцев — это 137 ₽/мес») and **per-plan device limits on each card**; no competitor tables, no fake discounts; checkout links unchanged.
