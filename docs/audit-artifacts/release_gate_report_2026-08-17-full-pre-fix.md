...
- Generated at: `2026-08-17 17:50:59`
- Status: `FAIL`
- Gate set: `default`
...
|---|---:|---:|
| Release pytest matrix | 0 | 1538.36 |
| Admin/auth regressions | 0 | 267.59 |
| Client security smoke | 2 | 0.47 |
| Client Flutter tests | 0 | 77.20 |
| API lifecycle smoke | 0 | 38.65 |
| Public link checks | 0 | 0.10 |
| Marketing production build | 0 | 28.33 |
| AdminApp production build | 0 | 27.54 |
| Admin webapp smoke | 0 | 0.19 |
| WebApp production build | 0 | 31.56 |
| WebApp Playwright E2E | 0 | 102.00 |
...
|---|---|---|---|
| current-origin check | local default gate set | FAIL | Runs on the operator workstation; does not prove brain-origin or RU-origin reachability. |
...
tests/test_api_payments_callbacks.py::ApiPaymentCallbacksTests::test_admin_plan_key_then_real_payment_still_starts_first_referral_hold
  C:\Users\kiwun\Documents\ai\VPN\tests\test_api_payments_callbacks.py:1078: DeprecationWarning: datetime.datetime.utcnow() is deprecated and scheduled for removal in a future version. Use timezone-aware objects to represent datetimes in UTC: datetime.datetime.now(datetime.UTC).
    ref_expiry = datetime.utcnow() + timedelta(days=20)

tests/test_api_payments_callbacks.py::ApiPaymentCallbacksTests::test_admin_plan_key_then_real_payment_still_starts_first_referral_hold
  C:\Users\kiwun\Documents\ai\VPN\tests\test_api_payments_callbacks.py:1092: DeprecationWarning: datetime.datetime.utcnow() is deprecated and scheduled for removal in a future version. Use timezone-aware objects to represent datetimes in UTC: datetime.datetime.now(datetime.UTC).
    invited_expiry = datetime.utcnow() + timedelta(days=5)

tests/test_api_payments_callbacks.py::ApiPaymentCallbacksTests::test_admin_plan_key_then_real_payment_still_starts_first_referral_hold
  C:\Users\kiwun\Documents\ai\VPN\tests\test_api_payments_callbacks.py:1108: DeprecationWarning: datetime.datetime.utcnow() is deprecated and scheduled for removal in a future version. Use timezone-aware objects to represent datetimes in UTC: datetime.datetime.now(datetime.UTC).
    now=datetime.utcnow(),

tests/test_api_payments_callbacks.py::ApiPaymentCallbacksTests::test_admin_plan_key_then_real_payment_still_starts_first_referral_hold
  C:\Users\kiwun\Documents\ai\VPN\tests\test_api_payments_callbacks.py:1180: DeprecationWarning: datetime.datetime.utcnow() is deprecated and scheduled for removal in a future version. Use timezone-aware objects to represent datetimes in UTC: datetime.datetime.now(datetime.UTC).
...
tests/test_api_payments_callbacks.py: 13 warnings
  C:\Users\kiwun\AppData\Local\Programs\Python\Python312\Lib\site-packages\httpx2\_models.py:422: DeprecationWarning: Use 'content=<...>' to upload raw bytes/text content.
...
tests/test_api_payments_callbacks.py::ApiPaymentCallbacksTests::test_create_public_order_applies_referral_first_purchase_discount
  C:\Users\kiwun\Documents\ai\VPN\tests\test_api_payments_callbacks.py:1379: DeprecationWarning: datetime.datetime.utcnow() is deprecated and scheduled for removal in a future version. Use timezone-aware objects to represent datetimes in UTC: datetime.datetime.now(datetime.UTC).
...
tests/test_api_payments_callbacks.py::ApiPaymentCallbacksTests::test_start99_public_order_ignores_referral_and_pending_discounts
  C:\Users\kiwun\Documents\ai\VPN\tests\test_api_payments_callbacks.py:1568: DeprecationWarning: datetime.datetime.utcnow() is deprecated and scheduled for removal in a future version. Use timezone-aware objects to represent datetimes in UTC: datetime.datetime.now(datetime.UTC).
    expiry_at=datetime.utcnow() + timedelta(days=30),

-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
642 passed, 19 warnings, 38 subtests passed in 1530.38s (0:25:30)
```

### Admin/auth regressions

- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_api_auth_and_tickets.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-gx_90osg`
- Exit: `0`

```text
................................................................ [ 68%]
.............................                                            [100%]
93 passed, 8 subtests passed in 265.11s (0:04:25)
```
...
[fail] Windows release seed must keep binary_name as pokrov_windows_beta.exe
[fail] Windows release seed must include required file pokrov_windows_beta.exe
```
...
> Task :video_player_android:checkKotlinGradlePluginConfigurationErrors SKIPPED
> Task :video_player_android:compileDebugKotlin UP-TO-DATE
> Task :video_player_android:javaPreCompileDebug UP-TO-DATE
> Task :video_player_android:compileDebugJavaWithJavac UP-TO-DATE
> Task :video_player_android:bundleLibCompileToJarDebug UP-TO-DATE
...
> Task :flutter_displaymode:bundleLibRuntimeToJarDebug UP-TO-DATE
> Task :flutter_displaymode:processDebugJavaRes NO-SOURCE
...
> Task :video_player_android:bundleLibRuntimeToJarDebug UP-TO-DATE
> Task :video_player_android:processDebugJavaRes UP-TO-DATE
> Task :app:testDebugUnitTest UP-TO-DATE

BUILD SUCCESSFUL in 6s
113 actionable tasks: 3 executed, 110 up-to-date
...
✓ Generating static pages using 19 workers (32/32) in 471.9ms
...
✓ Generating static pages using 5 workers (18/18) in 580ms
  Finalizing page optimization ...
...
```text
  ...
  ok 41 e2e\cabinet-flow.spec.ts:983:7 › Cabinet flow › links a trial entitlement to compact checkout (495ms)
  ok 42 e2e\cabinet-flow.spec.ts:1020:7 › Cabinet flow › shows branded root and cabinet not-found recovery screens (480ms)
  ok 43 e2e\cabinet-flow.spec.ts:1032:7 › Cabinet flow › shows subscription manual connection only as an explicit fallback (809ms)
  ok 44 e2e\cabinet-flow.spec.ts:1053:7 › Cabinet flow › builds the Happ URL without leaking it to third parties (534ms)
  ok 45 e2e\cabinet-flow.spec.ts:1081:7 › Cabinet flow › keeps manual setup closed from a direct hash when no active link exists (462ms)
  ok 46 e2e\cabinet-flow.spec.ts:1095:7 › Cabinet flow › keeps paid plan cards selectable for a free monthly account (701ms)
  ok 47 e2e\cabinet-flow.spec.ts:1159:7 › Cabinet flow › renders runtime connections on devices and keeps statistics as its own safe-summary page (961ms)
  ok 48 e2e\cabinet-flow.spec.ts:1182:7 › Cabinet flow › issues a one-time device code without exposing the subscription URL (731ms)
  ok 49 e2e\cabinet-flow.spec.ts:1191:7 › Cabinet flow › searches fallback guides and the POKROV screen atlas on mobile (1.4s)
  ok 50 e2e\cabinet-flow.spec.ts:1224:7 › Cabinet flow › submits a competitor-switch application without automatic reward (1.4s)
  ok 51 e2e\cabinet-flow.spec.ts:1246:7 › Cabinet flow › keeps redeem as a compact activation task (661ms)
  ok 52 e2e\cabinet-flow.spec.ts:1260:7 › Cabinet flow › keeps cabinet copy human and hides node internals (914ms)
  ok 53 e2e\cabinet-flow.spec.ts:1274:7 › Cabinet flow › settings exposes clear Telegram bonus actions without raw account details (2.0s)
  ok 54 e2e\cabinet-flow.spec.ts:1292:7 › Cabinet flow › shows honest payment history and a compact Russian checkout (1.2s)
  ...
  ok 57 e2e\cabinet-flow.spec.ts:1425:7 › Cabinet flow › sends staged attachment id without the private media triplet (3.4s)
  ok 58 e2e\cabinet-flow.spec.ts:1507:7 › Cabinet flow › keeps legal documents as compact support rows (620ms)
  ok 59 e2e\cabinet-flow.spec.ts:1520:7 › Cabinet flow › stays inside a narrow mobile viewport for core cabinet pages (811ms)
  ok 60 e2e\rewards.spec.ts:268:7 › rewards fail-closed cabinet surface › shows anonymized referral conversion and history (645ms)
  ok 61 e2e\rewards.spec.ts:286:7 › rewards fail-closed cabinet surface › keeps calendar usable when wheel state fails (451ms)
  ok 62 e2e\rewards.spec.ts:294:7 › rewards fail-closed cabinet surface › keeps wheel usable when calendar state fails (456ms)
  ok 63 e2e\rewards.spec.ts:302:7 › rewards fail-closed cabinet surface › does not invent sectors or animate an unknown committed reward (734ms)
  ok 64 e2e\rewards.spec.ts:312:7 › rewards fail-closed cabinet surface › renders one sector as a guaranteed reward card (467ms)
  ok 65 e2e\rewards.spec.ts:327:9 › rewards fail-closed cabinet surface › fails closed for missing sectors (468ms)
  ok 66 e2e\rewards.spec.ts:327:9 › rewards fail-closed cabinet surface › fails closed for duplicate sectors (475ms)
  ok 67 e2e\rewards.spec.ts:327:9 › rewards fail-closed cabinet surface › fails closed for non-positive sectors (464ms)
  ok 68 e2e\rewards.spec.ts:327:9 › rewards fail-closed cabinet surface › fails closed for too many sectors (463ms)
  ok 69 e2e\rewards.spec.ts:327:9 › rewards fail-closed cabinet surface › fails closed for excessive reward (468ms)
  ok 70 e2e\rewards.spec.ts:337:9 › rewards fail-closed cabinet surface › keeps FREE rewards ineligible (470ms)
  ok 71 e2e\rewards.spec.ts:337:9 › rewards fail-closed cabinet surface › keeps TRIAL rewards ineligible (510ms)
  ok 72 e2e\rewards.spec.ts:337:9 › rewards fail-closed cabinet surface › keeps BONUS rewards ineligible (527ms)
  ok 73 e2e\rewards.spec.ts:347:7 › rewards fail-closed cabinet surface › keeps expired rewards ineligible (490ms)
  ok 74 e2e\rewards.spec.ts:355:7 › rewards fail-closed cabinet surface › renders disabled features without mutation controls (463ms)
  ok 75 e2e\rewards.spec.ts:365:7 › rewards fail-closed cabinet surface › accepts the server same-day calendar response (709ms)
  ok 76 e2e\rewards.spec.ts:374:7 › rewards fail-closed cabinet surface › refetches wheel state and entitlement after committed reward (698ms)
  ok 77 e2e\rewards.spec.ts:387:7 › rewards fail-closed cabinet surface › refetches calendar state and entitlement after check-in (699ms)
