...
- Generated at: `2026-05-07 03:07:01`
- Status: `PASS`
- Gate set: `quick`
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_worker_retention.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-mm7m826z`
- Exit: `0`
...
✓ Generating static pages using 19 workers (30/30) in 367.0ms
  Finalizing page optimization ...
...
Running 32 tests using 1 worker
  ...
  ok  1 e2e\admin-gate.spec.ts:900:7 › Admin gate › redirects non-admin from /admin/* to /dashboard (506ms)
  ok  2 e2e\admin-gate.spec.ts:906:7 › Admin gate › allows admin to open all admin sections (4.3s)
  ok  3 e2e\admin-gate.spec.ts:930:7 › Admin gate › keeps an explicit path back to the cabinet from admin (1.9s)
  ok  4 e2e\admin-gate.spec.ts:941:7 › Admin gate › groups admin routes by operational category and keeps Telegram as fallback only (1.2s)
  ok  5 e2e\admin-gate.spec.ts:956:7 › Admin gate › keeps admin dashboard stable when summary omits optional blocks (1.1s)
  ok  6 e2e\admin-gate.spec.ts:976:7 › Admin gate › shows clean Russian copy across admin surfaces (2.1s)
  ok  7 e2e\admin-gate.spec.ts:998:7 › Admin gate › lets admin search, sort, and paginate the users table (2.7s)
  ...
  ok 11 e2e\admin-gate.spec.ts:1134:7 › Admin gate › shows observer-lite empty state instead of misleading zero-only activity (1.8s)
  ok 12 e2e\admin-gate.spec.ts:1150:7 › Admin gate › keeps admin pages clickable and inside the viewport on mobile (3.4s)
  ok 13 e2e\admin-gate.spec.ts:1207:7 › Admin gate › shows node alert labels and probe failure details (1.1s)
  ...
  ok 15 e2e\admin-gate.spec.ts:1364:7 › Admin gate › keeps rollout targeting fields and feed objects intact across save and reload (2.4s)
  ok 16 e2e\admin-gate.spec.ts:1404:7 › Admin gate › lets admin triage a ticket and send a reply using stable status codes (3.5s)
  ok 17 e2e\admin-gate.spec.ts:1438:7 › Admin gate › shows payment ledger and requires an audit note for manual reconciliation (2.0s)
  ok 18 e2e\cabinet-flow.spec.ts:347:7 › Cabinet flow › shows shared POKROV cabinet branding and a site return link (972ms)
  ok 19 e2e\cabinet-flow.spec.ts:362:7 › Cabinet flow › shows an honest email-soon state on the root auth entry (1.0s)
  ok 20 e2e\cabinet-flow.spec.ts:377:7 › Cabinet flow › keeps the email entry truthful when live delivery is not configured (785ms)
  ok 21 e2e\cabinet-flow.spec.ts:392:7 › Cabinet flow › reuses an existing web session and lands in the cabinet without showing auth entry again (1.0s)
  ok 22 e2e\cabinet-flow.spec.ts:401:7 › Cabinet flow › shows a human reauth CTA when the browser session is expired (690ms)
  ok 23 e2e\cabinet-flow.spec.ts:419:7 › Cabinet flow › keeps the dashboard on consumer-safe access actions (985ms)
  ok 24 e2e\cabinet-flow.spec.ts:435:7 › Cabinet flow › keeps cabinet navigation on native Next.js routing (1.1s)
  ok 25 e2e\cabinet-flow.spec.ts:456:7 › Cabinet flow › shows branded root and cabinet not-found recovery screens (986ms)
  ok 26 e2e\cabinet-flow.spec.ts:468:7 › Cabinet flow › shows subscription manual connection only as an explicit fallback (2.8s)
  ok 27 e2e\cabinet-flow.spec.ts:485:7 › Cabinet flow › renders runtime connections on devices and keeps statistics as its own safe-summary page (1.2s)
  ok 28 e2e\cabinet-flow.spec.ts:503:7 › Cabinet flow › keeps cabinet copy human and hides node internals (1.6s)
  ok 29 e2e\cabinet-flow.spec.ts:517:7 › Cabinet flow › settings exposes clear Telegram bonus actions without raw account details (4.8s)
  ok 30 e2e\cabinet-flow.spec.ts:532:7 › Cabinet flow › shows honest payment history and Russian checkout continuation copy (1.3s)
  ok 31 e2e\cabinet-flow.spec.ts:549:7 › Cabinet flow › keeps downloads and support flows usable without the app (4.3s)
  ok 32 e2e\cabinet-flow.spec.ts:576:7 › Cabinet flow › stays inside a narrow mobile viewport for core cabinet pages (2.0s)
