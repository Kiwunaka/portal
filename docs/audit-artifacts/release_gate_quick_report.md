...
- Generated at: `2026-04-25 02:04:24`
- Status: `PASS`
- Gate set: `quick`
...
|---|---:|---:|
| Critical worker regression | 0 | 5.88 |
| Client security smoke | 0 | 0.07 |
| Client portal Flutter tests | 0 | 20.35 |
| API lifecycle smoke | 0 | 8.18 |
| Public link checks | 0 | 0.10 |
| Marketing production build | 0 | 45.58 |
| Admin webapp smoke | 0 | 1.05 |
| WebApp production build | 0 | 43.47 |
| WebApp Playwright E2E | 0 | 92.95 |
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_worker_retention.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-xl14w5vl`
- Exit: `0`
...
✓ Generating static pages using 19 workers (30/30) in 460.6ms
  Finalizing page optimization ...
...
Running 31 tests using 1 worker
  ...
  ok  1 e2e\admin-gate.spec.ts:900:7 › Admin gate › redirects non-admin from /admin/* to /dashboard (676ms)
  ...
  ok 10 e2e\admin-gate.spec.ts:1093:7 › Admin gate › shows observer-lite badges, filters, and detail diagnostics (1.7s)
  ...
  ok 13 e2e\admin-gate.spec.ts:1207:7 › Admin gate › shows node alert labels and probe failure details (1.3s)
  ok 14 e2e\admin-gate.spec.ts:1287:7 › Admin gate › shows node context with separate panel, dataplane, and transport detail (1.2s)
  ok 15 e2e\admin-gate.spec.ts:1364:7 › Admin gate › keeps rollout targeting fields and feed objects intact across save and reload (2.7s)
  ok 16 e2e\admin-gate.spec.ts:1404:7 › Admin gate › lets admin triage a ticket and send a reply using stable status codes (2.6s)
  ok 17 e2e\admin-gate.spec.ts:1438:7 › Admin gate › shows payment ledger and requires an audit note for manual reconciliation (1.2s)
  ok 18 e2e\cabinet-flow.spec.ts:347:7 › Cabinet flow › shows shared POKROV cabinet branding and a site return link (1.1s)
  ok 19 e2e\cabinet-flow.spec.ts:362:7 › Cabinet flow › shows an honest email-soon state on the root auth entry (835ms)
  ok 20 e2e\cabinet-flow.spec.ts:377:7 › Cabinet flow › keeps the email entry truthful when live delivery is not configured (856ms)
  ...
  ok 23 e2e\cabinet-flow.spec.ts:417:7 › Cabinet flow › keeps cabinet navigation on native Next.js routing (1.8s)
  ok 24 e2e\cabinet-flow.spec.ts:438:7 › Cabinet flow › shows branded root and cabinet not-found recovery screens (1.2s)
  ...
  ok 26 e2e\cabinet-flow.spec.ts:462:7 › Cabinet flow › renders runtime connections on devices and keeps statistics as its own safe-summary page (1.3s)
  ok 27 e2e\cabinet-flow.spec.ts:480:7 › Cabinet flow › keeps cabinet copy human and hides node internals (1.4s)
  ok 28 e2e\cabinet-flow.spec.ts:494:7 › Cabinet flow › settings exposes clear Telegram bonus actions without raw account details (1.6s)
  ok 29 e2e\cabinet-flow.spec.ts:509:7 › Cabinet flow › shows honest payment history and Russian checkout continuation copy (1.3s)
  ok 30 e2e\cabinet-flow.spec.ts:526:7 › Cabinet flow › keeps downloads and support flows usable without the app (1.7s)
  ok 31 e2e\cabinet-flow.spec.ts:553:7 › Cabinet flow › stays inside a narrow mobile viewport for core cabinet pages (2.2s)
