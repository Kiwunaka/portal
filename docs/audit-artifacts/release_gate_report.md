...
Traceback (most recent call last):
  ...
  File "C:\Users\kiwun\AppData\Local\Programs\Python\Python312\Lib\site-packages\_pytest\pathlib.py", line 359, in cleanup_dead_symlinks
    if not left_dir.resolve().exists():
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "C:\Users\kiwun\AppData\Local\Programs\Python\Python312\Lib\pathlib.py", line 860, in exists
    self.stat(follow_symlinks=follow_symlinks)
  File "C:\Users\kiwun\AppData\Local\Programs\Python\Python312\Lib\pathlib.py", line 840, in stat
    return os.stat(self, follow_symlinks=follow_symlinks)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
PermissionError: [WinError 5] �������� � �������: 'C:\\Users\\kiwun\\AppData\\Local\\Temp\\pytest-of-kiwun\\pytest-current'
```
