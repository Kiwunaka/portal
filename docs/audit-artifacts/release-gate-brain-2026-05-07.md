...
- Generated at: `2026-05-07 23:17:17`
- Status: `PASS`
- Gate set: `quick`
...
|---|---:|---:|
| Brain-origin runtime/static verify | 0 | 4.57 |
| Node predeploy readiness | 0 | 98.20 |
| Critical worker regression | 0 | 6.47 |
| Payment and marketing release honesty | 0 | 36.22 |
| Paid checkout launch evidence tooling | 0 | 1.16 |
| GitHub release tooling | 0 | 1.25 |
| Client preflight | 0 | 0.10 |
| Client security smoke | 0 | 0.07 |
| Client portal Flutter tests | 0 | 19.71 |
| API lifecycle smoke | 0 | 8.52 |
| Public link checks | 0 | 0.09 |
| Marketing production build | 0 | 14.36 |
| Admin webapp smoke | 0 | 0.15 |
| WebApp production build | 0 | 18.55 |
| WebApp Playwright E2E | 0 | 104.51 |
...
[health443] {"status":"ok","ts":"2026-05-07T20:11:30.238333"}
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_worker_retention.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-ummgfq_k`
- Exit: `0`
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_bot_paywall.py tests/test_marketing_release_readiness.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-z0wgacz1`
- Exit: `0`
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_paid_checkout_launch_evidence_check.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-xyeq1cee`
- Exit: `0`
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_prepare_github_release_plan.py tests/test_publish_github_release_assets.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-ktc1g94r`
- Exit: `0`
...
✓ Generating static pages using 19 workers (31/31) in 406.6ms
  Finalizing page optimization ...
...
```text
  ...
  ok  6 e2e\admin-gate.spec.ts:1037:7 › Admin gate › keeps release cockpit email gate blocked when public email mode is disabled (1.2s)
  ok  7 e2e\admin-gate.spec.ts:1052:7 › Admin gate › keeps admin dashboard stable when summary omits optional blocks (1.2s)
  ok  8 e2e\admin-gate.spec.ts:1072:7 › Admin gate › shows clean Russian copy across admin surfaces (1.6s)
  ok  9 e2e\admin-gate.spec.ts:1094:7 › Admin gate › lets admin search, sort, and paginate the users table (2.5s)
  ...
  ok 12 e2e\admin-gate.spec.ts:1189:7 › Admin gate › shows observer-lite badges, filters, and detail diagnostics (2.8s)
  ...
  ok 14 e2e\admin-gate.spec.ts:1246:7 › Admin gate › keeps admin pages clickable and inside the viewport on mobile (3.6s)
  ...
  ok 19 e2e\admin-gate.spec.ts:1534:7 › Admin gate › shows payment ledger and requires an audit note for manual reconciliation (2.1s)
  ok 20 e2e\cabinet-flow.spec.ts:475:7 › Cabinet flow › shows shared POKROV cabinet branding and a site return link (2.5s)
  ok 21 e2e\cabinet-flow.spec.ts:490:7 › Cabinet flow › shows an honest email-soon state on the root auth entry (952ms)
  ok 22 e2e\cabinet-flow.spec.ts:503:7 › Cabinet flow › keeps the email entry truthful when live delivery is not configured (913ms)
  ok 23 e2e\cabinet-flow.spec.ts:516:7 › Cabinet flow › supports enabled email register verify login and recovery from the auth entry (10.8s)
  ok 24 e2e\cabinet-flow.spec.ts:571:7 › Cabinet flow › keeps email verification and recovery tokens separate (4.8s)
  ...
  ok 26 e2e\cabinet-flow.spec.ts:600:7 › Cabinet flow › stores a silently refreshed web session returned from Telegram auth (1.2s)
  ok 27 e2e\cabinet-flow.spec.ts:619:7 › Cabinet flow › shows a human reauth CTA when the browser session is expired (809ms)
  ...
  ok 32 e2e\cabinet-flow.spec.ts:703:7 › Cabinet flow › renders runtime connections on devices and keeps statistics as its own safe-summary page (1.8s)
  ...
  ok 35 e2e\cabinet-flow.spec.ts:750:7 › Cabinet flow › shows honest payment history and Russian checkout continuation copy (1.3s)
  ok 36 e2e\cabinet-flow.spec.ts:768:7 › Cabinet flow › keeps checkout disabled when payment providers are configured but launch evidence is blocked (3.6s)
  ok 37 e2e\cabinet-flow.spec.ts:802:7 › Cabinet flow › checks and redeems access keys from the cabinet redeem route (2.9s)
  ok 38 e2e\cabinet-flow.spec.ts:867:7 › Cabinet flow › keeps downloads and support flows usable without the app (4.0s)
  ok 39 e2e\cabinet-flow.spec.ts:894:7 › Cabinet flow › loads protected support attachments through authenticated blob fetch (1.2s)
  ok 40 e2e\cabinet-flow.spec.ts:914:7 › Cabinet flow › stays inside a narrow mobile viewport for core cabinet pages (1.4s)
