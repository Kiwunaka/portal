...
- Generated at: `2026-05-08 03:52:15`
- Status: `PASS`
- Gate set: `quick`
...
|---|---:|---:|
| Brain-origin runtime/static verify | 0 | 6.09 |
| Node predeploy readiness | 0 | 68.32 |
| Critical worker regression | 0 | 6.25 |
| Payment and marketing release honesty | 0 | 36.32 |
| Paid checkout launch evidence tooling | 0 | 0.96 |
| GitHub release tooling | 0 | 0.75 |
| External access preflight tooling | 0 | 0.77 |
| Client preflight | 0 | 0.10 |
| Client security smoke | 0 | 0.07 |
| Client portal Flutter tests | 0 | 29.15 |
| API lifecycle smoke | 0 | 8.20 |
| Public link checks | 0 | 0.09 |
| Marketing production build | 0 | 15.01 |
| Admin webapp smoke | 0 | 0.15 |
| WebApp production build | 0 | 20.74 |
| WebApp Playwright E2E | 0 | 98.88 |
...
[health443] {"status":"ok","ts":"2026-05-08T00:46:48.446250"}
[webapp443] <!DOCTYPE html><!--IRImOrDYKJBfP71QQ_98Q--><html lang="ru" class="scroll-smooth"><head><meta charSet="utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_worker_retention.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-_uspw75a`
- Exit: `0`
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_bot_paywall.py tests/test_marketing_release_readiness.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-zdr1_t6f`
- Exit: `0`
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_paid_checkout_launch_evidence_check.py tests/test_live_probe_scripts.py tests/test_freekassa_api_probe.py tests/test_freekassa_staging_smoke.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-o1ni3e60`
- Exit: `0`
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_prepare_github_release_plan.py tests/test_publish_github_release_assets.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-tmtjrie3`
- Exit: `0`
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_public_beta_external_access_preflight.py tests/test_public_beta_launch_decision.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-naggztl_`
- Exit: `0`
...
✓ Generating static pages using 19 workers (31/31) in 403.1ms
  Finalizing page optimization ...
...
```text
  ...
  ok  6 e2e\admin-gate.spec.ts:1037:7 › Admin gate › keeps release cockpit app gate blocked for Play or non-GitHub app links (1.1s)
  ok  7 e2e\admin-gate.spec.ts:1063:7 › Admin gate › keeps release cockpit email gate blocked when public email mode is disabled (1.0s)
  ok  8 e2e\admin-gate.spec.ts:1078:7 › Admin gate › keeps admin dashboard stable when summary omits optional blocks (1.1s)
  ok  9 e2e\admin-gate.spec.ts:1098:7 › Admin gate › shows clean Russian copy across admin surfaces (1.9s)
  ok 10 e2e\admin-gate.spec.ts:1120:7 › Admin gate › lets admin search, sort, and paginate the users table (2.4s)
  ok 11 e2e\admin-gate.spec.ts:1150:7 › Admin gate › keeps the users filters synced into the URL and restores them on reload (1.3s)
  ok 12 e2e\admin-gate.spec.ts:1177:7 › Admin gate › lets admin safely delete only manual or test users (3.3s)
  ok 13 e2e\admin-gate.spec.ts:1215:7 › Admin gate › shows observer-lite badges, filters, and detail diagnostics (2.9s)
  ok 14 e2e\admin-gate.spec.ts:1256:7 › Admin gate › shows observer-lite empty state instead of misleading zero-only activity (2.4s)
  ok 15 e2e\admin-gate.spec.ts:1272:7 › Admin gate › keeps admin pages clickable and inside the viewport on mobile (3.6s)
  ok 16 e2e\admin-gate.spec.ts:1329:7 › Admin gate › shows node alert labels and probe failure details (1.1s)
  ok 17 e2e\admin-gate.spec.ts:1409:7 › Admin gate › shows node context with separate panel, dataplane, and transport detail (1.1s)
  ok 18 e2e\admin-gate.spec.ts:1486:7 › Admin gate › keeps rollout targeting fields and feed objects intact across save and reload (2.3s)
  ok 19 e2e\admin-gate.spec.ts:1526:7 › Admin gate › lets admin triage a ticket and send a reply using stable status codes (2.5s)
  ok 20 e2e\admin-gate.spec.ts:1560:7 › Admin gate › shows payment ledger and requires an audit note for manual reconciliation (2.1s)
  ok 21 e2e\cabinet-flow.spec.ts:475:7 › Cabinet flow › shows shared POKROV cabinet branding and a site return link (1.1s)
  ok 22 e2e\cabinet-flow.spec.ts:490:7 › Cabinet flow › shows an honest email-soon state on the root auth entry (791ms)
  ok 23 e2e\cabinet-flow.spec.ts:503:7 › Cabinet flow › keeps the email entry truthful when live delivery is not configured (917ms)
  ok 24 e2e\cabinet-flow.spec.ts:516:7 › Cabinet flow › supports enabled email register verify login and recovery from the auth entry (10.6s)
  ok 25 e2e\cabinet-flow.spec.ts:571:7 › Cabinet flow › keeps email verification and recovery tokens separate (5.4s)
  ok 26 e2e\cabinet-flow.spec.ts:591:7 › Cabinet flow › reuses an existing web session and lands in the cabinet without showing auth entry again (1.1s)
  ok 27 e2e\cabinet-flow.spec.ts:600:7 › Cabinet flow › stores a silently refreshed web session returned from Telegram auth (1.0s)
  ok 28 e2e\cabinet-flow.spec.ts:619:7 › Cabinet flow › shows a human reauth CTA when the browser session is expired (661ms)
  ok 29 e2e\cabinet-flow.spec.ts:637:7 › Cabinet flow › keeps the dashboard on consumer-safe access actions (1.1s)
  ok 30 e2e\cabinet-flow.spec.ts:653:7 › Cabinet flow › keeps cabinet navigation on native Next.js routing (1.5s)
  ok 31 e2e\cabinet-flow.spec.ts:674:7 › Cabinet flow › shows branded root and cabinet not-found recovery screens (1.4s)
  ok 32 e2e\cabinet-flow.spec.ts:686:7 › Cabinet flow › shows subscription manual connection only as an explicit fallback (1.3s)
  ok 33 e2e\cabinet-flow.spec.ts:703:7 › Cabinet flow › renders runtime connections on devices and keeps statistics as its own safe-summary page (1.1s)
  ok 34 e2e\cabinet-flow.spec.ts:721:7 › Cabinet flow › keeps cabinet copy human and hides node internals (1.3s)
  ok 35 e2e\cabinet-flow.spec.ts:735:7 › Cabinet flow › settings exposes clear Telegram bonus actions without raw account details (1.9s)
  ok 36 e2e\cabinet-flow.spec.ts:750:7 › Cabinet flow › shows honest payment history and Russian checkout continuation copy (1.5s)
  ok 37 e2e\cabinet-flow.spec.ts:768:7 › Cabinet flow › keeps checkout disabled when payment providers are configured but launch evidence is blocked (1.0s)
  ok 38 e2e\cabinet-flow.spec.ts:802:7 › Cabinet flow › checks and redeems access keys from the cabinet redeem route (1.3s)
  ok 39 e2e\cabinet-flow.spec.ts:867:7 › Cabinet flow › keeps downloads and support flows usable without the app (3.8s)
  ok 40 e2e\cabinet-flow.spec.ts:895:7 › Cabinet flow › loads protected support attachments through authenticated blob fetch (1.1s)
  ok 41 e2e\cabinet-flow.spec.ts:915:7 › Cabinet flow › stays inside a narrow mobile viewport for core cabinet pages (1.6s)
