...
- Generated at: `2026-05-08 00:41:20`
- Status: `PASS`
- Gate set: `quick`
...
|---|---:|---:|
| Critical worker regression | 0 | 6.68 |
| Payment and marketing release honesty | 0 | 36.17 |
| Paid checkout launch evidence tooling | 0 | 1.23 |
| GitHub release tooling | 0 | 1.28 |
| External access preflight tooling | 0 | 1.22 |
| Client preflight | 0 | 0.09 |
| Client security smoke | 0 | 0.06 |
| Client portal Flutter tests | 0 | 19.42 |
| API lifecycle smoke | 0 | 8.49 |
| Public link checks | 0 | 0.09 |
| Marketing production build | 0 | 13.96 |
| Admin webapp smoke | 0 | 0.14 |
| WebApp production build | 0 | 17.84 |
| WebApp Playwright E2E | 0 | 100.80 |
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_worker_retention.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-5n73_5ia`
- Exit: `0`
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_bot_paywall.py tests/test_marketing_release_readiness.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-2npvzjwk`
- Exit: `0`
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_paid_checkout_launch_evidence_check.py tests/test_live_probe_scripts.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-e9ax2x_g`
- Exit: `0`
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_prepare_github_release_plan.py tests/test_publish_github_release_assets.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-0okbyh40`
- Exit: `0`
...
- Command: `C:\Users\kiwun\AppData\Local\Programs\Python\Python312\python.exe -m pytest tests/test_public_beta_external_access_preflight.py -q --basetemp C:\Users\kiwun\Documents\ai\VPN\.tmp\pytest-basetemp\release-gate-cidw8o0c`
- Exit: `0`
...
```text
  ...
  ok  4 e2e\admin-gate.spec.ts:1002:7 › Admin gate › groups admin routes by operational category and keeps Telegram as fallback only (1.4s)
  ok  5 e2e\admin-gate.spec.ts:1017:7 › Admin gate › shows release cockpit no-go state with runtime gates and external blockers (1.2s)
  ok  6 e2e\admin-gate.spec.ts:1037:7 › Admin gate › keeps release cockpit email gate blocked when public email mode is disabled (1.3s)
  ok  7 e2e\admin-gate.spec.ts:1052:7 › Admin gate › keeps admin dashboard stable when summary omits optional blocks (1.3s)
  ok  8 e2e\admin-gate.spec.ts:1072:7 › Admin gate › shows clean Russian copy across admin surfaces (1.6s)
  ok  9 e2e\admin-gate.spec.ts:1094:7 › Admin gate › lets admin search, sort, and paginate the users table (2.4s)
  ...
  ok 11 e2e\admin-gate.spec.ts:1151:7 › Admin gate › lets admin safely delete only manual or test users (3.0s)
  ok 12 e2e\admin-gate.spec.ts:1189:7 › Admin gate › shows observer-lite badges, filters, and detail diagnostics (2.9s)
  ok 13 e2e\admin-gate.spec.ts:1230:7 › Admin gate › shows observer-lite empty state instead of misleading zero-only activity (1.9s)
  ok 14 e2e\admin-gate.spec.ts:1246:7 › Admin gate › keeps admin pages clickable and inside the viewport on mobile (3.8s)
  ok 15 e2e\admin-gate.spec.ts:1303:7 › Admin gate › shows node alert labels and probe failure details (1.3s)
  ...
  ok 18 e2e\admin-gate.spec.ts:1500:7 › Admin gate › lets admin triage a ticket and send a reply using stable status codes (2.6s)
  ok 19 e2e\admin-gate.spec.ts:1534:7 › Admin gate › shows payment ledger and requires an audit note for manual reconciliation (2.5s)
  ok 20 e2e\cabinet-flow.spec.ts:475:7 › Cabinet flow › shows shared POKROV cabinet branding and a site return link (1.2s)
  ok 21 e2e\cabinet-flow.spec.ts:490:7 › Cabinet flow › shows an honest email-soon state on the root auth entry (891ms)
  ok 22 e2e\cabinet-flow.spec.ts:503:7 › Cabinet flow › keeps the email entry truthful when live delivery is not configured (1.0s)
  ok 23 e2e\cabinet-flow.spec.ts:516:7 › Cabinet flow › supports enabled email register verify login and recovery from the auth entry (10.7s)
  ok 24 e2e\cabinet-flow.spec.ts:571:7 › Cabinet flow › keeps email verification and recovery tokens separate (5.3s)
  ok 25 e2e\cabinet-flow.spec.ts:591:7 › Cabinet flow › reuses an existing web session and lands in the cabinet without showing auth entry again (1.2s)
  ok 26 e2e\cabinet-flow.spec.ts:600:7 › Cabinet flow › stores a silently refreshed web session returned from Telegram auth (1.3s)
  ok 27 e2e\cabinet-flow.spec.ts:619:7 › Cabinet flow › shows a human reauth CTA when the browser session is expired (794ms)
  ok 28 e2e\cabinet-flow.spec.ts:637:7 › Cabinet flow › keeps the dashboard on consumer-safe access actions (1.2s)
  ok 29 e2e\cabinet-flow.spec.ts:653:7 › Cabinet flow › keeps cabinet navigation on native Next.js routing (1.2s)
  ...
  ok 32 e2e\cabinet-flow.spec.ts:703:7 › Cabinet flow › renders runtime connections on devices and keeps statistics as its own safe-summary page (1.3s)
  ok 33 e2e\cabinet-flow.spec.ts:721:7 › Cabinet flow › keeps cabinet copy human and hides node internals (1.4s)
  ok 34 e2e\cabinet-flow.spec.ts:735:7 › Cabinet flow › settings exposes clear Telegram bonus actions without raw account details (1.5s)
  ok 35 e2e\cabinet-flow.spec.ts:750:7 › Cabinet flow › shows honest payment history and Russian checkout continuation copy (1.7s)
  ok 36 e2e\cabinet-flow.spec.ts:768:7 › Cabinet flow › keeps checkout disabled when payment providers are configured but launch evidence is blocked (1.2s)
  ...
  ok 39 e2e\cabinet-flow.spec.ts:895:7 › Cabinet flow › loads protected support attachments through authenticated blob fetch (1.3s)
  ok 40 e2e\cabinet-flow.spec.ts:915:7 › Cabinet flow › stays inside a narrow mobile viewport for core cabinet pages (1.4s)
