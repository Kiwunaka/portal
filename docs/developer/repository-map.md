...
| --- | --- | --- |
| `portal_bot/` | FastAPI backend, Telegram bots, worker, canonical-account projection, device-session security, data model, panel sync | root canonical docs plus `portal_bot/api.py`, `portal_bot/account_foundation_service.py`, `portal_bot/auth_session_service.py`, `portal_bot/app_first_service.py`, `portal_bot/channel_bonus_service.py`, `portal_bot/warp_service.py`, and related tests |
