...
- GitHub Actions workflows set `FORCE_JAVASCRIPT_ACTIONS_TO_NODE24="true"` so repository guardrails run against the upcoming Node 24 actions runtime before GitHub's 2026 forced migration.
