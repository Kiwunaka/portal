...
- capacity rollout flags default to `CAPACITY_AWARE_NODE_SELECTION=true`, `SUBSCRIPTION_DYNAMIC_ORDERING=true`, `SUBSCRIPTION_EXCLUDE_HARD_REJECT=false`, `KEY_PRESSURE_SCORING=true`, `KEY_PRESSURE_FAIR_USE_ROUTING=false`, and `USERNODE_MAPPING_AS_CANDIDATE_LIMIT=false`
