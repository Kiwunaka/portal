...
output=root/('server-'+profile+'-result.json');assert not output.exists(),'Preserve prior result'
...
try:
 with postgres_lab('portal_r12_a04_auto_20260909_live_'+profile+'_v1') as (engine,vm):
