...
for profile in ('awg2_lab','awg31_lab'):
    ...
    assert reads[2]['test_peers']==reads[3]['test_peers'],'Stale key caused accepted peer traffic'
...
names=['prepare.py','run.py','server-controller.py','verify-and-retain.py','build.json','server-before.json','server-after.json','awg2_lab-lifecycle.json','awg31_lab-lifecycle.json']
