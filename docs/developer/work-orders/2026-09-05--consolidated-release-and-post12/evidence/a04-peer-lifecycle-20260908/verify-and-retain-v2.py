...
names=['prepare.py','run.py','server-controller.py','verify-and-retain.py','verify-and-retain-v2.py','verifier-v1-result.json','build.json','server-before.json','server-after.json','awg2_lab-lifecycle.json','awg31_lab-lifecycle.json']
