...
root=Path('E:/r12-internal-vision-platform-20260909');out=Path(__file__).resolve().parent
revision=subprocess.check_output(['git','rev-parse','HEAD'],cwd=root).decode().strip()
expected_tree='8b4f13f0d108e252a917091a282cb4be340e9b51'
...
base=json.loads(Path('E:/r12-awg-migration-20260909/worker-payload.json').read_bytes())
before={r['source_path']:r for r in base['files']}
expected={'portal_bot/support_case_context.py','portal_bot/support_agent_provider.py','portal_bot/support_agent_harness.py','portal_bot/support_agent_service.py'}
rows=[];changed=set()
