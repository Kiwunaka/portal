...
for url,surface,relative in [
 ...
 ('https://pokrov.space/webapp/','webapp','index.html'),
...
target=out/'static-deployed-verified.json';assert not target.exists();target.write_text(json.dumps(report,indent=2)+'\n')
