...
root=Path('E:/r12-worker-logging-20260909');out=Path(__file__).resolve().parent
revision=subprocess.check_output(['git','rev-parse','HEAD'],cwd=root).decode().strip()
expected_tree='8192c61f21c72aeb1bbc083009c99a579c961790'
...
base=json.loads(Path('E:/r12-support-integration-20260909/backend-merged-payload-plan.json').read_bytes())
before={r['source_path']:r for r in base['files']}
expected={'portal_bot/worker.py'}
rows=[];changed=set()
