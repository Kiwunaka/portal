...
manifest = json.loads((out / 'worker-payload.json').read_bytes())
code = r'''
...
assert old['PORTAL_BUILD_COMMIT']=='7d37005e4260995ab44ec3adb14bbffa3d42738b'
...
fd,tmp=tempfile.mkstemp(prefix='.env.r12-worker-build-',dir=path.parent)
try:
...
'''
target=out/'worker-build-identity-updated.json'
