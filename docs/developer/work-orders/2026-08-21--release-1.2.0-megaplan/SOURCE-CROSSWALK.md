...
7. **Hysteria2 is a closed owner lab.** The owner reopened a bounded, default-off managed UDP/QUIC selector/fallback on 2026-08-28. Local source/artifact/default-off proof is `I3`; it is not the sole bootstrap and has no server, live-handshake, performance, RU-origin or release claim. Gecko, Mimic and port hopping remain monitor-only.
