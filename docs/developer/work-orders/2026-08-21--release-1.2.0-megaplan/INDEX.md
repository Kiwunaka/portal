...
- `WO-013BO-candidate6-pb14-build-binding.md`
  ...
  without rebuilding the signed candidate or advancing Gate F.
...
`I3` and leave the Gate F count unchanged.
