...
| 11 | Exact-candidate RC matrix, immutable promotion, rollback and go/no-go | Candidate.32 is the current private signed candidate. Its six-file supply/signature and Android static identity pass. WO-013GK adds exact Windows in-place replacement, ordinary UI/trusted IPC, disconnected initialization and managed reboot proof without assigning clean-install or connected-network credit. WO-013GG adds exact Gates A–E source replay with zero source failures and an isolated byte-identical portal/client rollback; WO-013GH independently validates `4/4` APKs and the AAB without assigning device or Store credit; WO-013GI reconciles seven stale current-authority rows; WO-013GJ retains predecessor evidence while retargeting all fourteen residual future blockers to candidate.32. The ledger slice changes no evidence levels and Gate F remains `BLOCKED 2/17/0` with zero validation errors. Physical Android, LDPlayer, Windows clean/migration/default/AWG/Smart-DNS/connected uninstall, exact current/Brain/RU origins, provider/Operator/legal, runtime rollback, comparable performance and final attestations remain non-PASS. No public `v1.2.0`, Store object, stable switch or promotion occurred | `WO-013`, `WO-013BK`–`WO-013GK` |
...
current exact Windows in-place/UI/IPC/disconnected-reboot authority.
