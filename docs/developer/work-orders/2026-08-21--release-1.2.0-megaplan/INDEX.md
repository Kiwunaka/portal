...
- `WO-013AS-owned-smart-dns-lab.md` binds the selective non-recursive DNS and
  ...
  `WO-013BH-smart-dns-portability-and-zero-purchase-plan.md` binds the current
  portable bundle plus seven-node PLAN matrix. Neither claims a free endpoint,
  deploy, live DNS/SNI relay, service access, leak/rollback/origin or candidate.
