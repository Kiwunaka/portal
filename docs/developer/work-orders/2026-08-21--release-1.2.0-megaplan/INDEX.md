...
| 11 | Exact-candidate RC matrix, immutable promotion, rollback and go/no-go | Candidates 5–9 remain immutable history. WO-013CM binds signed private candidate.10 to supply/signing, exact Brain `197/197 + 23/23 + 7/7`, canonical Pi and exact LDPlayer AWG2/AWG3.1. WO-013CP proves that disabled Brain and Free were stale draining targets with no live consumer route, clears only their guarded control-plane drain flags after separate backups and repeats the canonical Pi as `FAIL 9/11` on NL and RU-SPB path timeouts. WO-013CO's exact Gate F remains `NO_GO 6 PASS / 13 non-PASS / 1 FAIL`; it is not regenerated while RU still fails. All five gates remain `BLOCKED`; the physical phone, connected clean-VM Windows, provider/Operator/legal and broader performance evidence remain manual. Hosted private zero-step checks remain non-PASS under the no-purchase solo policy. No tag, public `v1.2.0`, Store object, stable switch or promotion occurred | `WO-013`, `WO-013BK`–`WO-013CP` |
