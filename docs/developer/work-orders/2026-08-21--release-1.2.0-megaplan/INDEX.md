...
Wave status: `PHASE_11_CANDIDATE8_SIGNED_GATE_F_BLOCKED_4_PASS_15_NONPASS`
...
a clean restore. The next release action is isolated Windows app/service/TUN/
DNS/recovery parity plus exact Brain/RU and remaining manual Gate F evidence.
