...
Wave status: `PHASE_11_CANDIDATE19_NO_GO_CANDIDATE20_SIGNED_WINDOWS11_DEFAULT_WIN003_PASS_ANDROID_ORIGIN_ROLLBACK_AGGREGATE_GATES_OPEN_GATE_F_NOT_RUN`
...
rollback/migration slice. The VM retained authorized user-level app state while
prior machine installation/service state was absent; this is not called a
fresh user profile. Candidate 20 LDPlayer install/launch, physical ARM64
