...
candidate.6 LDPlayer per-app/WARP/force-stop slice but leaves physical Android,
DNS/IPv6 leak and Gate F unchanged.
...
origin block and restoring default/WARP-off/no-material state. The exact
