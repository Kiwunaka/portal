...
- Current open symbol review buckets are `public_symbol_review = 12` and `client_package_public_api_review = 3`; remaining stronger runtime claims still require manual-gate/platform/provider evidence where the audit labels them as such.
