...
- `client_package_public_api_review` means a public Flutter/Dart package API exists without a direct story/test signal in the root audit; current count is `0`.
