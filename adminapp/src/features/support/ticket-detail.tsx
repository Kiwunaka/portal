...
export function TicketDetail({ ticket, permissions, onRefresh }: { ticket: AdminTicket; permissions: string[]; onRefresh: () => void }) {
  ...
  const [bundleAttempts, setBundleAttempts] = useState<Record<string, string>>({});
    ...
    <>
      <div className="space-y-3">
        ...
        <Card>
          ...
          {selectedAttempt ? <ConnectivityReport data={selectedAttempt.connectivity} /> : null}
