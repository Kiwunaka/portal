...
const REASON_TEXT: Record<string, string> = {
  ...
  brain_panel_failed: "Панель не отдала пригодные метрики Brain",
  brain_panel_unavailable: "Панель недоступна для получения метрик Brain",
  ...
  runtime_panel_failed: "Получение текущего состояния панели завершилось сбоем",
  runtime_panel_unavailable: "Панель недоступна для получения текущего состояния",
