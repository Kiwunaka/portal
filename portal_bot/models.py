...
class Node(Base):
    ...
    edge_reachability_ok = Column(Boolean, nullable=True)
    authenticated_egress_ok = Column(Boolean, nullable=True)
    last_authenticated_egress_at = Column(DateTime, nullable=True)
    authenticated_egress_error_kind = Column(String(64), nullable=True)
