...
_FALLBACKS: dict[str, str] = {
    ...
    "bot.menu.home": (
        "🛡 *POKROV VPN*\n\n"
        "Выберите один следующий шаг. Остальные настройки спрятаны в разделе «Ещё»."
    ),
    "bot.menu.returning": (
        "👋 *POKROV готов к работе*\n\n"
        "Продолжите с главного действия или проверьте свой доступ."
    ),
    "bot.menu.new_user": (
        "🛡 *POKROV VPN*\n\n"
    ...
    "bot.tariffs.long": (
        ...
        "Чем дольше доступ, тем ниже цена месяца. Годовой план экономит 30% против помесячной оплаты: "
    ...
    "bot.instruction.pick_device": (
        ...
        "Android и Windows: официальный файл, вход и одна кнопка. "
        "Для iPhone, iPad и Mac пока используется личный ключ в совместимом приложении."
    ),
    "bot.instruction.verify": (
        "✅ *Как проверить POKROV*\n\n"
        "1. Скачайте приложение для Android или Windows\n"
        "2. Войдите и нажмите «Подключить»\n"
        "3. Откройте YouTube, TikTok или ChatGPT\n\n"
        "Первые 5 дней бесплатны, карта не нужна."
    ),
    "bot.instruction.platform_ios": (
        "🍏 *Apple: iPhone, iPad и Mac*\n\n"
        "Отдельного приложения POKROV для Apple пока нет. Установите совместимое приложение, "
        "затем получите здесь личный ключ или QR.\n\n"
        "На Android используйте APK POKROV, на Windows — EXE."
    ),
    "bot.instruction.platform_android": (
        "🤖 *Android*\n\n"
        "ARM64 — основной и самый лёгкий файл для большинства телефонов.\n\n"
        "1. Скачайте APK и разрешите установку\n"
        "2. Откройте POKROV\n"
        "3. Нажмите «Подключить»\n\n"
        "ARMv7 и universal нужны только если основной APK не устанавливается."
    ),
    "bot.instruction.platform_windows": (
        ...
        "3. Нажмите «Подключить»\n\n"
        "Личный ключ для Windows не нужен."
    ),
