...
def render_synthesis_policy_prompt(policy: SupportAgentPolicy) -> str:
    lines = (
        ...
        "Base the reply on the single most directly relevant selected topic. Do not combine unrelated topic bodies.",
        ...
        "With status answer, never claim that you transferred, created, updated, or checked anything, or that support will return with an answer.",
