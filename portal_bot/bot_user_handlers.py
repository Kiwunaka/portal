...
async def show_referral(callback: CallbackQuery):
    ...
    await callback.message.edit_text(
        ...
        f"Друг получит *+{REFERRAL_FRIEND_DAYS} дней* после своей первой успешной оплаты.\n"
        f"Вы получите *+{REFERRAL_BONUS_DAYS} дней* после его первой оплаты и проверки {REFERRAL_HOLD_HOURS} часа.\n\n"
...
FAQ_ANSWERS = {
    ...
    "referral": (
        ...
        f"• Друг получает *+{REFERRAL_FRIEND_DAYS} дней* после своей первой успешной оплаты\n"
        f"• Вы получаете *+{REFERRAL_BONUS_DAYS} дней* после его первой оплаты и проверки {REFERRAL_HOLD_HOURS} часа\n\n"
