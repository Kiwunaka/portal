...
class Settings:
    ...
    COMMERCIAL_OFFER_HMAC_SECRET: str = os.getenv("COMMERCIAL_OFFER_HMAC_SECRET", "").strip()
    COMMERCIAL_OFFER_HOLD_TTL_SECONDS: int = env_int("COMMERCIAL_OFFER_HOLD_TTL_SECONDS", 600)
    PAYMENT_RETURN_HMAC_SECRET: str = os.getenv("PAYMENT_RETURN_HMAC_SECRET", "").strip()
    PAYMENT_RETURN_TOKEN_TTL_SECONDS: int = env_int("PAYMENT_RETURN_TOKEN_TTL_SECONDS", 604800)
    PAYMENT_RETURN_PENDING_TTL_SECONDS: int = env_int("PAYMENT_RETURN_PENDING_TTL_SECONDS", 259200)
    COMMERCIAL_CAPACITY_AUTOMATION_ENABLED: bool = env_bool(
        "COMMERCIAL_CAPACITY_AUTOMATION_ENABLED", True
    )
    COMMERCIAL_CAPACITY_AUTOMATION_INTERVAL_SECONDS: int = env_int(
        "COMMERCIAL_CAPACITY_AUTOMATION_INTERVAL_SECONDS", 300
    )
    ...
    APP_RELEASE_SCHEMA_VERSION: int = env_int("APP_RELEASE_SCHEMA_VERSION", 0)
    APP_RELEASE_CANDIDATE_LABEL: str = os.getenv("APP_RELEASE_CANDIDATE_LABEL", "").strip()
    APP_RELEASE_HANDOFF_SHA256: str = os.getenv("APP_RELEASE_HANDOFF_SHA256", "").strip()
    APP_RELEASE_ARTIFACT_SET_SHA256: str = os.getenv("APP_RELEASE_ARTIFACT_SET_SHA256", "").strip()
    APP_RELEASE_CORE_VERSION: str = os.getenv("APP_RELEASE_CORE_VERSION", "").strip()
    APP_RELEASE_CORE_DESKTOP_ABI: int = env_int("APP_RELEASE_CORE_DESKTOP_ABI", 0)
    APP_RELEASE_CORE_ANDROID_PACKAGE: str = os.getenv("APP_RELEASE_CORE_ANDROID_PACKAGE", "").strip()
    APP_ANDROID_PLAY_URL: str = os.getenv("APP_ANDROID_PLAY_URL", "").strip()
    APP_ANDROID_APK_URL: str = os.getenv("APP_ANDROID_APK_URL", "").strip()
    APP_ANDROID_APK_ARM64_URL: str = os.getenv("APP_ANDROID_APK_ARM64_URL", "").strip()
    APP_ANDROID_APK_ARMEABI_V7A_URL: str = os.getenv("APP_ANDROID_APK_ARMEABI_V7A_URL", "").strip()
    APP_ANDROID_APK_X86_64_URL: str = os.getenv("APP_ANDROID_APK_X86_64_URL", "").strip()
    APP_ANDROID_APK_UNIVERSAL_URL: str = os.getenv("APP_ANDROID_APK_UNIVERSAL_URL", "").strip()
    ...
    APP_ANDROID_ARM64_SHA256: str = os.getenv("APP_ANDROID_ARM64_SHA256", "").strip()
    APP_ANDROID_ARMEABI_V7A_SHA256: str = os.getenv("APP_ANDROID_ARMEABI_V7A_SHA256", "").strip()
    APP_ANDROID_X86_64_SHA256: str = os.getenv("APP_ANDROID_X86_64_SHA256", "").strip()
    APP_ANDROID_UNIVERSAL_SHA256: str = os.getenv("APP_ANDROID_UNIVERSAL_SHA256", "").strip()
    APP_ANDROID_SIZE_BYTES: int = env_int("APP_ANDROID_SIZE_BYTES", 0)
    APP_ANDROID_ARM64_SIZE_BYTES: int = env_int("APP_ANDROID_ARM64_SIZE_BYTES", 0)
    APP_ANDROID_ARMEABI_V7A_SIZE_BYTES: int = env_int("APP_ANDROID_ARMEABI_V7A_SIZE_BYTES", 0)
    APP_ANDROID_X86_64_SIZE_BYTES: int = env_int("APP_ANDROID_X86_64_SIZE_BYTES", 0)
    APP_ANDROID_UNIVERSAL_SIZE_BYTES: int = env_int("APP_ANDROID_UNIVERSAL_SIZE_BYTES", 0)
